...
function loadImages() {
  const imageBasePaths = [
    'Laptop1',
    'Laptop2',
    'PXL_20250323_160322465',
    '7C3D60D1',
    '90F0C5E6',
    '20221004_120102_52451203335_o',
    '20230724_175008_53069450409_o',
    '345395045_170564368972787_6665234763286219141_n',
    '355629772_244930084928187_1855928167094146817_n.',
    'fb_20150313_18_04_30_saved_picture_51326593041_o',
    'fb_20150313_18_05_11_saved_picture_51326796233_o',
    'fb_20150313_18_05_19_saved_picture_51326796243_o',
    'fb_20150313_18_05_27_saved_picture_51326593076_o',
    'fb_20150313_18_05_35_saved_picture_51327586415_o',
    'fb_20150313_18_05_44_saved_picture_51327586465_o',
    'fb_20150313_18_05_48_saved_picture_51326593111_o',
    'fb_20150313_18_05_53_saved_picture_51325859672_o',
    'fb_20150313_18_06_08_saved_picture_51326593121_o',
    'fb_20150313_18_06_11_saved_picture_51326593136_o',
    'fb_20150313_18_06_15_saved_picture_51326593146_o',
    'fb_20150313_18_06_26_saved_picture_51327316319_o',
    'fb_20150313_18_06_31_saved_picture_51327586520_o',
    'fb_20150313_18_06_57_saved_picture_51327586525_o',
    'fb_20150313_18_07_05_saved_picture_51327586535_o',
    'fb_20150313_18_07_13_saved_picture_51325859702_o',
    'img_1673_51326796338_o',
    'img_20190525_152829_51327316514_o',
    'img_20190525_155627_51327586745_o',
    'img_20220607_074132_52129919165_o',
    'img_9608_51326796353_o',
    'img_9609_51327586580_o',
    'mclsulb_51326802273_o',
    'my-laptop_52017362697_o',
    'pxl_20211129_013117201_51815277150_o',
    'pxl_20211204_181140704_51813597007_o',
    'pxl_20220607_001435630_52129919140_o',
    'pxl_20220607_002716509_52129919150_o',
    'PXL_20221202_204454125',
    'PXL_20221203_051025900',
    'PXL_20221203_160930924',
    'PXL_20221228_222816583~2',
    'pxl_20230508_003704126_53069653555_o',
    'pxl_20230508_003709543_53069758848_o',
    'pxl_20230508_004156096_53069451774_o',
    'pxl_20230508_004200396_53069257256_o',
    'PXL_20230514_003432146',
    'PXL_20230618_214610864',
    'rivulq9_51327322214_o',
    'tweaked-the-crap-out-of-the-atom-ide_52018444358_o',
    'unknown-1_51713771065_o',
    'v__2f3b_51327586785_o',
    'v__e513_51327316384_o',
    'wp_20150317_001_51326593391_o',
    'wp_20160905_17_25_44_pro_51327316409_o',
    'wp_20160905_17_26_42_rich_51326796458_o',
    'wp_20160905_17_26_57_rich_51327586695_o',
    'wtavvym_51326802258_o',
    'xfce-my-retro-ms-dos-theme-for-xubuntu_52017360277_o',
  ];
  ...
  imageBasePaths.forEach(baseName => {

    let originalExtension = '.jpg';

    let fullSizePath = `Pictures/${baseName}${originalExtension}`;
    let thumbnailPath = `Thumbnails/${baseName}_thumb${originalExtension}`;
  ...
  originalImagePaths.forEach(originalPath => {
    const filename = originalPath.split('/').pop(); // Get 'Laptop1.jpg'
    const [name, ext] = filename.split('.'); // Get 'Laptop1' and 'jpg'
    const thumbnailFilename = `${name}_thumb.${ext}`; // Construct 'Laptop1_thumb.jpg'
    const thumbnailPath = `Thumbnails/${thumbnailFilename}`; // Construct full thumbnail path

    const img = document.createElement('img');
    img.src = thumbnailPath; // Use the thumbnail for display
    img.classList.add('gallery-image');
    galleryContainer.appendChild(img);

    // Add click event listener to each image to open the full-size original
    img.addEventListener('click', function() {
      toggleFullSizeImageDisplay(originalPath); // Pass the original full-size path
    });
  });
}

// Function to toggle display of full-size image (opens in new tab)
function toggleFullSizeImageDisplay(path) {
